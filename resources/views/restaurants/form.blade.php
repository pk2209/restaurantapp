...
<div class="sbox">
	...
	<div class="sbox-content"> 	
		...
		<ul class="parsley-error-list">
		 ...
		 {!! Form::open(array('url'=>'restaurants/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
				...
				{!! Form::hidden('id', $row['id']) !!}					
						     ...
						     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-7">
										  <input  type='text' name='logo' id='logo' value='{{ $row['logo'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-1">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('restaurants?return='.$return) }}' " class="btn btn-warning btn-sm "><i class="icon-cancel-circle2 "></i>  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("restaurants/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
